...
def temperatura_cidade(
    ...
    # Fica com o primeiro resultado, que é a ordenação do próprio serviço.
    # Testei desempatar por população, para nomes ambíguos: em 12 nomes a
    # escolha mudou em 2, e nas 2 para pior — "Salvador" passou a devolver El
    # Salvador (o país, 6,4 M) em vez da cidade da Bahia, e "Valencia" trocou a
    # Espanha pela Venezuela. A ordenação do open-meteo já pondera relevância
    # melhor do que população sozinha.
    local = resultados[0]
    previsao = _consultar(
        WEATHER_URL,
        {
